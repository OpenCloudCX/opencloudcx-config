...
echo " --------- Assume role"
aws sts assume-role --role-arn "arn:aws:iam:::role/${RANDOM_SEED}-ocxbootstrap-codebuild-kubectl-role" --role-session-name OpenCloudCXEKSSession --query "Credentials" > assume-credentials.json
