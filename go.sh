...
kubectl exec -it -n spinnaker spinnaker-spinnaker-halyard-0 -- bash -c "hal config ci jenkins master add jenkins --address $INGRESS_ENDPOINT --username admin --password $JENKINS_ADMIN_TOKEN"
